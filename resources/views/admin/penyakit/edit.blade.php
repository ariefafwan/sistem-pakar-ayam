...
@section('body')
<div class="form-edit-penyakit col-lg-12 shadow-lg rounded p-3">
    <a href="{{ route('penyakit.index') }}" class="btn btn-danger my-3">
        <i class="fa fa-arrow-circle-left" aria-hidden="true"></i>&nbspBack
    </a>
    <form class="col-lg-12" action="{{ route('penyakit.update', $penyakit->id) }}" method="post"
        ...
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="kd_penyakit" name="kd_penyakit"
                value="{{ old('kd_penyakit', $penyakit->kd_penyakit) }}" placeholder="Masukkan kode penyakit" autofocus>
        </div>
        <div class="mb-3">
            ...
            <input type="text" class="form-control" id="nama_penyakit" name="nama_penyakit"
                value="{{ old('nama_penyakit', $penyakit->nama_penyakit) }}" placeholder="Masukkan nama penyakit">
        </div>
        <div class="mb-3">
            ...
            <textarea class="form-control" id="det_penyakit" name="det_penyakit" rows="3"
                placeholder="Masukkan detail penyakit">{{ old('det_penyakit', $penyakit->det_penyakit) }}</textarea>
        </div>
        <div class="mb-3">
            ...
            <textarea class="form-control" id="solusi_penyakit" name="solusi_penyakit" rows="3"
                placeholder="Masukkan solusi penyakit">{{ old('solusi_penyakit', $penyakit->solusi_penyakit) }}</textarea>
        </div>
        <div class="mb-3">
