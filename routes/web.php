...
Route::middleware('auth')->group(function () {
    ...
    Route::middleware('user')->group(function () {
        // Route::get('/home', [App\Http\Controllers\HomeController::class, 'index'])->name('home');
        //diagnosa
        Route::get('/mualaidiagnosa', [UserController::class, 'index'])->name('diagnosauser.create');
        Route::get('/riwayat-diagnosa', [UserController::class, 'riwayat'])->name('riwayat.user');
        Route::post('/hasildiagnosa', [UserController::class, 'diagnosauser'])->name('diagnosauser.store');
